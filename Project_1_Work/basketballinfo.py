...
tab1 = tk.Frame(planner, bg='#00E8FF', width=200, height=200)
tab2 = tk.Frame(planner, bg='#00E8FF', width=200, height=200)
tab3 = tk.Frame(planner, bg='#00E8FF', width=200, height=200)
tab4 = tk.Frame(planner, bg='#00E8FF', width=200, height=200)
tab5 = tk.Frame(planner, bg='#00E8FF', width=200, height=200)



# Add the tabs/frames to the notebook object called "planner" 
planner.add(tab1, text='Home')
planner.add(tab2, text='Stats')
planner.add(tab3, text='Awards')
planner.add(tab4, text="Teams")
planner.add(tab5, text="Seasons")
